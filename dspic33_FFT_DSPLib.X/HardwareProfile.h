...
//#define SD_TRIS			(TRISAbits.TRISA0)
//#define SD_I			(PORTAbits.RA0)
//#define SD_O			(LATAbits.LATA0)
#define LD1_TRIS		(TRISBbits.TRISB15)		// LD1 - on MicroStick
#define LD1_I			(PORTBbits.RB15)
#define LD1_O			(LATBbits.LATB15)
//#define IO1_TRIS		(TRISAbits.TRISA2)		// LD2 (I/O 1)
//#define IO1_I			(PORTAbits.RA2)	
//#define IO1_O			(LATAbits.LATA2)	
